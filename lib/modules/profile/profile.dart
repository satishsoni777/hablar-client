...
import 'package:take_it_easy/modules/profile/controller/profile_controller.dart';
...
class UserProfile extends StatelessWidget {
  ...
  final contorller=ProfileController();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider<ProfileController>.value(
        value: contorller,
  ...
  Widget _body(BuildContext context, {UserData? gmailUserData}) {
    return Consumer<ProfileController>(
      builder: (context, ProfileController provider,a) {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ProfileTile(
                ...
                onPressed: () {
                 provider.onTap(Routes.feedbackList);
                },
                icon: (Icons.contact_phone),
              ),
              ProfileTile(
